...
if [[ "$KORONA_RELAY_MAX_MEMORY_MB" != "" ]]; then MAX_MEMORY_MB=$KORONA_RELAY_MAX_MEMORY_MB; fi
# To manually specify max memory set the environment variable KORONA_RELAY_MAX_MEMORY_MB,
