   ...
   <modules>
      ...
      <module name="CommentModule">
         <parameters>
            ...
            <parameter name="Label">GENERATE PHANTOM ECHOGRAMS:</parameter>
      ...
      <module name="PhantomModule">
         <parameters>
            ...
            <parameter name="FanAggregationType">None</parameter>
            <parameter name="FanAggregationHalfWidth">0</parameter>
         </parameters>
      </module>
      <module name="CommentModule">
         <parameters>
            ...
            <parameter name="LineBreak">true</parameter>
            <parameter name="VerticalSpace">8</parameter>
            <parameter name="Label">SPIKE NOISE REMOVAL FROM ECHOGRAM:</parameter>
            <parameter name="Comment"/>
         </parameters>
      </module>
